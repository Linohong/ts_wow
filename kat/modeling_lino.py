...
class BartEncoder(nn.Module):
    ...
    def __init__(self, config: BartConfig, embed_tokens):
        ...
        # if config.static_position_embeddings:  # 에러나서 주석함
        ...
        # self.layernorm_embedding = LayerNorm(embed_dim) if config.normalize_embedding else nn.Identity()  # 에러나서 주석함
...
class DecoderLayer(nn.Module):
    ...
    def forward(
        ...
        src_hidden_states = encoder_hidden_states
...
class BartDecoder(nn.Module):
    ...
    def __init__(self, config: BartConfig, embed_tokens: nn.Embedding):
        ...
        self.embed_tokens = embed_tokens
        # if config.static_position_embeddings:  # 리노 주석
        #     self.embed_positions = SinusoidalPositionalEmbedding(
        ...
        # self.layernorm_embedding = LayerNorm(config.d_model) if config.normalize_embedding else nn.Identity()  # 리노 주석
        self.layernorm_embedding = nn.Identity()
...
class BartModel(PretrainedBartModel):
    ...
    def forward(
        ...
        **kwargs,
        ...
        src_hidden = encoder_outputs["last_hidden_state"]
